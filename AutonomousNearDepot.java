...
@TeleOp(name="Autonomous Near Depot", group="Pushbot")
public class AutonomousNearDepot extends LinearOpMode {
    public ElapsedTime period = new ElapsedTime();
    RobotConfig  robot = new RobotConfig();
    GamePieceDrop dropper  = new GamePieceDrop();
    //LatchingControl_Linear stringArmClass = new LatchingControl_Linear();
    ...
    public void runOpMode()
    {
        ...
        telemetry.addData("has run", "has run");
        ...
        moveCm(robot, -55,0.6);
        turnDegrees(robot, -35);
        moveCm(robot, -55,0.6);
        turnDegrees(robot, -90);
        moveCm(robot,90,0.6);
        dropper.dropGamePiece(robot);
        turnDegrees(robot, -90);
        moveCm(robot, -165,1.0);
        //latch.servoLatch(robot);
    }
